...
urban_config.map_grid_size   = 5    # 3D map discretization
urban_config.map_x_len       = 600  # [m]
urban_config.map_y_len       = 800  # [m]
urban_config.ave_width       = 60   # avenue width [m]
urban_config.st_width        = 20   # street width [m]
urban_config.blk_size_x      = 200
urban_config.blk_size_y      = 200
urban_config.blk_size_small  = 100
urban_config.blk_size_min    = 80
...
urban_config.bld_dense       = 0.001  # building density
...
# ───── Pack into params dict used by main.py ────────────────────
...
# Optional helper (used only by some scripts; harmless for main.py)
